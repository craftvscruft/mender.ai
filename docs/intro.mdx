...
**Innovation**: The deliberate implementation of ideas resulting in new or improved products or methods. The ability to innovate implies being goal-directed and adaptable.
...
**Adaptable**: Able to respond gracefully to new unknown events (see also [Resilience 4](https://www.researchgate.net/publication/276139783_Four_concepts_for_resilience_and_the_implications_for_the_future_of_resilience_engineering), sustained adaptive capacity).
